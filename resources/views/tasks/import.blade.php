...
@section('content')
    ...
    <div class="form-container">
        <div class="form-card">
            <h1 class="form-title">Import Tasks</h1>
            <form id="importForm" action="{{-- route('tasks.import.handle') --}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="help-text">
                    ...
                    <div class="help-content">
                        <ul>
                            ...
                            <li>Task Date (optional, format YYYY-MM-DD)</li>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('downloadTemplate').addEventListener('click', function(e) {
            e.preventDefault();
            const csvContent = 'Description,Task Date,Duration,Client Name\n' +
