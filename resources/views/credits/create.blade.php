...
@section('title', 'New Credit - Bee Company')
...
:root {
    ...
    /* Main Content Area */
    .main-content {
    margin-top: 0px; /* was 70px, now smaller to move content up */
    padding: 20px 30px;
  ...
  <div class="breadcrumb-container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">New Credit</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="form-content">
    <div class="tab-content" id="CreditTabsContent">
      <div class="tab-pane fade show active" id="create" role="tabpanel">
        <form action="{{ route('credits.store') }}" method="POST" id="newCreditForm">
          @csrf
          ...
          <div class="client-section">
            <div class="form-group">
              ...
              <a href="{{ route('clients.create') }}" class="new-client-btn">New Client</a>
            </div>
          </div>

          <!-- Credit Details -->
          <div class="Credit-details">
            <div class="Credit-details-left">
              <div class="form-group">
                <label class="form-label" for="credit_date">Credit Date</label>
                <input type="date" class="form-control" id="credit_date" name="credit_date" value="{{ old('credit_date', date('Y-m-d')) }}" required>
              </div>
              <div class="form-group">
            ...
            <div class="Credit-details-right">
              <div class="form-group">
                <label class="form-label" for="credit_number">Credit #</label>
                <input type="text" class="form-control" id="credit_number" name="credit_number" required>
              </div>
              <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary mt-3">Save Credit</button>
        </form>
      </div>
