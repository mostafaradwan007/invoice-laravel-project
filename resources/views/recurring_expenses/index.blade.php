...
<head>
    ...
    <title>Recurring Expenses - Bee Company</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb-container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Recurring Expenses</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="page-controls">
            <div class="left-controls">
                ...
                <div class="actions-dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#"><i class="bi bi-pencil me-2"></i>Edit Selected</a>
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-trash me-2"></i>Delete Selected</a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-download me-2"></i>Export
                                Selected</a></li>
                    </ul>
                </div>
            ...
            <div class="right-controls">
                ...
                <!-- New Product Button -->
                <button class="new-product-btn" type="button"
                    onclick="window.location.href='{{ route('recurring_expense.create') }}'">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to delete this recurring_expense?
                    </div>
        ...
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    @forelse($recurring_expense as $expense)
                        <tr>
                           ...
                           <td>{{ $expense->client->name ?? 'N/A' }}</td>
                            ...
                            <td>{{ $expense->next_send_date }}</td>
                            <td>{{ $expense->remaining_cycle }}</td>
                            <td>{{ number_format($expense->amount, 2) }}</td>
                            <td>{{ $expense->publicnotes }}</td>
                            <td>{{ $expense->state }}</td>

                                <td>
                                <a href="{{ route('recurring_expense.edit', $expense->id) }}"
                                    class="btn btn-sm btn-info btn-yellow-hover btn-yellow-hover">Edit</a>

                                <button type="button" class="btn btn-sm btn-danger btn-yellow-hover btn-yellow-hover"
    ...
    <script>
     ...
     <script>
        function confirmDelete(recurring_expenseId) {
            const form = document.getElementById('deleteForm');
form.action = `/recurring_expenses/${recurring_expenseId}`;
