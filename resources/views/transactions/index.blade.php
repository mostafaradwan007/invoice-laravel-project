...
<head>
    ...
    <title>Transactions - Bee Company</title>
                ...
                <tbody>
                    @forelse($transactions as $transaction)
                        <tr>
                            ...
                            <td>{{ $transaction->invoices }}</td>
                            <td>{{ $transaction->expense }}</td>

                            <td>
                                <a href="{{ route('transactions.edit', $transaction->id) }}"
                                    class="btn btn-sm btn-info btn-yellow-hover">Edit</a>

                                <button type="button" class="btn btn-sm btn-danger btn-yellow-hover"
